...
int Play(int RT,int CT,int origin);//Bouton Play, pour jouer � Bomberman
void AffichageNiveauJeu(int MenuNiveau);//Affichage du niveau en jeu
...
void ChoixPerso(int x_perso,int y_perso,int *MenuPerso, int x_perso2,int y_perso2 ,int *MenuPerso2,int RT,int CT,int origin,int MenuPlayer,int typeperso1,int typeperso2);//Bouton pour choisir le personnage
...
void AffichageItem(int RT,int CT,int nb_vie,int nb_bombes,int rayon ,int speed,int choixperso,int perso,int typeperso,int xorigin);//Permet l'appel des 2 fonctions pour l'affichage des powerups des persos
